...
namespace WorldMapStrategyKit {
    public class DemoStandAlone : MonoBehaviour {
        ...
        void OnGUI() {
            ...
            if (GUI.Button(new Rect(GUIResizer.authoredScreenWidth - 190, 500, 180, 30), "  Non Overlapping Circles", buttonStyle)) {
                DrawNonOverlappingCircles();
            }
        ...
        void DrawNonOverlappingCircles() {
