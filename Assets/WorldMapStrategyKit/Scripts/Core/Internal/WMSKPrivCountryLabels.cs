            ...
            for (int k = 0; k < _countries.Length; k++) {
                ...
                if (tm != null) {
                    ...
                    if (tm.color.a != newAlpha) {
                        ...
                        Color underlayColor = tm.fontSharedMaterial.GetColor("_UnderlayColor");
                        tm.fontSharedMaterial.SetColor("_UnderlayColor", new Color(underlayColor.r, underlayColor.g, underlayColor.b, newAlpha));
                    }
                }
            }
        }
